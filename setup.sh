...
UNO_DIR="$REPO_ROOT/packages/uno"
PRODUCT_UNO_DIR="$REPO_ROOT/packages/product-uno"
...
ensure_project_environments() {
    ...
    ensure_project_environment "$UNO_DIR" "packages/uno"
    ensure_project_environment "$PRODUCT_UNO_DIR" "packages/product-uno"
