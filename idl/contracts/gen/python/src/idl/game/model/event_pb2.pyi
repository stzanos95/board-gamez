...
class SessionStarted(_message.Message):
    __slots__ = ("session_id", "game_type", "participants", "version", "seed")
    ...
    version: int
    seed: int
    def __init__(self, session_id: _Optional[str] = ..., game_type: _Optional[_Union[_game_type_pb2.GameType, str]] = ..., participants: _Optional[_Iterable[_Union[_participant_pb2.Participant, _Mapping]]] = ..., version: _Optional[int] = ..., seed: _Optional[int] = ...) -> None: ...
...
class DeadlineExpired(_message.Message):
    __slots__ = ("session_id", "is_over", "version")
    SESSION_ID_FIELD_NUMBER: _ClassVar[int]
    IS_OVER_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    session_id: str
    is_over: bool
    version: int
    def __init__(self, session_id: _Optional[str] = ..., is_over: bool = ..., version: _Optional[int] = ...) -> None: ...
