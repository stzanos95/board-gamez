...
class UnoSession(_message.Message):
    __slots__ = ("id", "view", "participant", "last_command_id", "version", "participant_statuses")
    ...
    def __init__(self, id: _Optional[str] = ..., view: _Optional[_Union[_view_pb2.UnoView, _Mapping]] = ..., participant: _Optional[int] = ..., last_command_id: _Optional[str] = ..., version: _Optional[int] = ..., participant_statuses: _Optional[_Iterable[_Union[_participant_state_pb2.ParticipantStatus, _Mapping]]] = ...) -> None: ...
