from idl.uno.model import action_pb2 as _action_pb2
from idl.uno.model import session_pb2 as _session_pb2
...
class StartGameResponse(_message.Message):
    ...
    session: _session_pb2.UnoSession
    def __init__(self, session: _Optional[_Union[_session_pb2.UnoSession, _Mapping]] = ...) -> None: ...
...
class PlayActionRequest(_message.Message):
    ...
    command_id: str
    player_id: str
    action: _action_pb2.UnoAction
    expected_version: int
    def __init__(self, table_id: _Optional[str] = ..., command_id: _Optional[str] = ..., player_id: _Optional[str] = ..., action: _Optional[_Union[_action_pb2.UnoAction, _Mapping]] = ..., expected_version: _Optional[int] = ...) -> None: ...
