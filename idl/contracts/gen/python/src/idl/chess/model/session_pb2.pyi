...
class ChessSession(_message.Message):
    __slots__ = ("id", "game", "color", "last_command_id", "version", "participant_statuses")
    ...
    def __init__(self, id: _Optional[str] = ..., game: _Optional[_Union[_game_pb2.ChessGame, _Mapping]] = ..., color: _Optional[_Union[_piece_pb2.Color, str]] = ..., last_command_id: _Optional[str] = ..., version: _Optional[int] = ..., participant_statuses: _Optional[_Iterable[_Union[_participant_state_pb2.ParticipantStatus, _Mapping]]] = ...) -> None: ...
