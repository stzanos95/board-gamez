...
class TableObj(_message.Message):
    __slots__ = ("metadata", "game_type", "status", "seats")
    ...
    def __init__(self, metadata: _Optional[_Union[_object_metadata_pb2.ObjectMetadata, _Mapping]] = ..., game_type: _Optional[_Union[_game_type_pb2.GameType, str]] = ..., status: _Optional[_Union[_table_pb2.TableStatus, str]] = ..., seats: _Optional[_Iterable[_Union[_seat_pb2.Seat, _Mapping]]] = ...) -> None: ...
